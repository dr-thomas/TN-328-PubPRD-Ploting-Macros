void DrawEff(){
  ...
  //TFile* inF = new TFile("/Volumes/ThomasDrive/p0dCCAnalysis/Selection/DataMCOverlays/RootFiles/FullRun5WaterIn.root", "OPEN");
  TFile* inF = new TFile("/Volumes/ThomasDrive/p0dCCAnalysis/Selection/DataMCOverlays/RootFiles/FullRun6AirFull.root", "OPEN");
  ...
  TH2F* signal2D = new TH2F("signal2D", "signal2D",nbins,Pmin,Pmax,nbins,Cmin,Cmax);
